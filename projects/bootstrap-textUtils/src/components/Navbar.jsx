        ...
        <>
            <nav className={`navbar navbar-expand-lg navbar-${props.mode}  bg-${props.mode}`}>
                <div className="container-fluid ">
                    <a className={`navbar-brand text-${textToggle}`} href="/">{props.title}</a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <a className={`nav-link active text-${textToggle}`} aria-current="page" href="/">Home</a>
                            </li>
                            <li className="nav-item"><div className=""></div>
                                <a className={`nav-link text-${textToggle}`} href="/">{props.aboutText}</a>
                            </li>
